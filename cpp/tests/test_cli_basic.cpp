// ==============================================================================
// test_cli_basic.cpp - Базовые тесты CLI (Step 24)
// ==============================================================================
//
...
// Полноценные тесты с GoogleTest будут добавлены в Step 25+.
//
// ==============================================================================
...
void test_unknown_command() {
    ...
    assert(result.diagnostic.exit_code == 1 && "Exit code should be 1");
