...
- Single Source of Truth для As‑Is архитектуры на фазе As‑Is (Step 9).
...
- Baseline upstream: `docs/baseline/BASELINE-0001-upstream.md` (ART-0012).
...
Связанный риск: RISK-0011 в `00_RISK_REGISTER.md`.

---

## 6) UNKNOWN/требует подтверждения запуском

На уровне Step 9 фиксируются места, где “точный внешний эффект” должен быть подтверждён golden runs (Step 13), потому что зависит от runtime/окружения:
