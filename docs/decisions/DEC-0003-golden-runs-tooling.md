...
- Эталонные прогоны должны сниматься на нескольких ОС (Windows/Linux/macOS) и храниться как внешние артефакты CI.
- Для сравнения с C++ позже понадобится дифф‑harness (Step 27), поэтому формат результатов должен быть стандартизирован.
...
- Минусы: до Step 27 ещё нет инфраструктуры сравнения; нужно иметь эталоны заранее, чтобы потом валидировать harness.
