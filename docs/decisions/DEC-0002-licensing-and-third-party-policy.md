...
- В проекте используются внешние входные артефакты:
  - Chainsaw (ART-0004)
  - Sigma rules (ART-0005)
  - EVTX-ATTACK-SAMPLES (ART-0006)
...
4) До формализации политики тестовых данных (Step 28) крупные upstream датасеты хранить как внешние артефакты.
