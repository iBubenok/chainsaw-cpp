...
## План верификации
- Step 27/33: байтовое совпадение stderr/stdout в CLI‑сценариях `RUN-0001…RUN-0104` и функциональных `RUN-*` подтверждает, что использование fmt не изменяет наблюдаемые форматы.
