...
## План верификации
- Step 32: перенос тестов, проверяющих семантику `search`/regex‑матчинга (см. `TESTMAT-0001`).
- Step 27/33: golden runs `RUN-0201…RUN-0204` (search по EVTX) должны совпадать по stdout/stderr/exit code согласно `GOV-0002`.
