...
## План верификации
- Step 24–26: базовый `ctest` прогон должен работать локально и в CI.
- Step 32: перенос `TST-0001…TST-0022` должен быть реализован на базе gtest или эквивалентных проверок.
