...
## План верификации
- Step 32: перенос/эквивалентные тесты `TST-0007…TST-0022` (конверсия Sigma → tau и модификаторы), которые чувствительны к YAML полям.
- Step 27/33: сценарии `RUN-0601` (lint Sigma) и сценарии `hunt`, зависящие от загрузки правил, сравнить через harness.
