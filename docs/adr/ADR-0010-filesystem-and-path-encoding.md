...
## План верификации
- Step 27/33: дифф‑сравнение сценариев, где путь наблюдаем (как минимум кейсы с пробелами/спецсимволами; см. `RISK-0007`).
- Step 31–33: добавить unit‑тесты на преобразования `path ⇄ string` для Windows и Unix‑семантик (в т.ч. не‑UTF8 байты на Unix через фикстуры).
